...
namespace ODataWebApp
{
    ...
    public partial class MaterialRequirement
    {
        ...
        {
            this.MaterialRequirement1 = new HashSet<MaterialRequirement>();
        ...
        public virtual ICollection<MaterialRequirement> MaterialRequirement1 { get; set; }
        public virtual MaterialRequirement MaterialRequirement2 { get; set; }
